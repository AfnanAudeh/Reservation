...
export class EmployeeService {
    ...
    DeleteEmployee(id?: number) {
        return this.http.delete(environment.apiUrl + "Register/DeleteWaiter/" + id, this.requestOptions)
    ...
    GetWaiterById(id: number) {
        return this.http.get(environment.apiUrl + "employee/GetWaiterById/" + id)
    }
    FilterWaiterByName(name: string) {
        return this.http.get(environment.apiUrl + "Employee/FilterWaiterById/" + name)
